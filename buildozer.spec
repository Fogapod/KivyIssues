...
source.include_exts = py,png,jpg,kv,rst,txt,json,ini,md
...
requirements = kivy,plyer,docutils,pil,openssl,requests,git+https://gitlab.com/kivymd/KivyMD.git
...
icon.filename = %(source.dir)s/data/images/kivy_logo.png
