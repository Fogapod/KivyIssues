...
po:
	xgettext -Lpython --output=messages.pot program.py libs/programclass/showplugins.py libs/programclass/authorization.py libs/programclass/showposts.py libs/uix/kv/activity/license.kv libs/uix/kv/activity/nawdrawer.kv libs/uix/kv/activity/baseclass/boxposts.py libs/uix/kv/activity/startscreen.kv
